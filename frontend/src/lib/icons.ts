...
export const ICONS = {
  ...
  // 字段级元数据锁定（第 35 期）：锁体 + 锁梁。刻意**不加 fill**（锁梁是开口线，填色会糊成一块），
  // 「已锁 / 未锁」靠锁梁闭/开 + 文字标注区分，与实心书签那种一眼可辨的语义不同。
  lock: '<rect x="4.6" y="10.4" width="14.8" height="9.6" rx="2"/><path d="M8.3 10.4V7.3a3.7 3.7 0 017.4 0v3.1"/>',
  unlock: '<rect x="4.6" y="10.4" width="14.8" height="9.6" rx="2"/><path d="M8.3 10.4V7.3a3.7 3.7 0 016.9-2.1"/>',
